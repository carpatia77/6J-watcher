...
def run_test():
    ...
    WITH full_clusters AS (
        ...
        WHERE symbol = '6J' 
          -- Filtro estrito para Janeiro/2026
    ...
    print("Processando Janeiro de 2026 (Analise OOS Integral - Sem Amostragem)...")
    df = conn.execute(query).fetchdf()
    print("========================================")
    print("JANEIRO 2026: absorption_passive_RANGING_LONDON")
    print("========================================")
