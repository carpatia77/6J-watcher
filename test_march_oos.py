...
def run_test():
    ...
    WITH full_clusters AS (
        ...
        WHERE symbol = '6J' 
          -- Filtro estrito para Marco/2026 (Mes do BoJ)
    ...
    print("Processando Marco de 2026 (Mes do BoJ - Reativacao de Catalisador)...")
    df = conn.execute(query).fetchdf()
    print("========================================")
    print("MARCO 2026: absorption_passive_RANGING_LONDON")
    print("========================================")
    
    if df.empty or df['total_samples'][0] == 0:
        print("Nenhuma amostra encontrada. O banco ja indexou Marco?")
        return
